...
class WandbLogger(Callback):
    ...
    def __init__(
        ...
        **logging_params,
        ...
        Args:
            ...
            log_each_n_batch (int): logs only once every log_each_n_batch batches.
                It has effect only if log_on_batch_end is True.
        ...
        self.log_each_n_batch = log_each_n_batch
        self._unlogged_batch_amount = 0
    ...
    def _log_metrics(
        ...
        metrics.update({'global_epoch': global_epoch})
        
        wandb.log(metrics, step=self._logging_index, commit=commit)
    ...
    def on_batch_end(self, state: State):
        ...
        if self.log_on_batch_end:
            if self._unlogged_batch_amount < self.log_each_n_batch:
                self._unlogged_batch_amount += 1         
            else:
                self._unlogged_batch_amount = 0
